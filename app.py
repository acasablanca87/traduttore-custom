...
st.markdown(
    ...
    "<span style='font-size: 0.5em; font-weight: normal; color: #888;'> Powered by Google Gemini ✨ | Web app created by acasablanca with the help of Google Gemini</span></h4>", 
    unsafe_allow_html=True
)
